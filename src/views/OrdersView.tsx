...
import { ClipboardList, Eye, Trash2, Clock, User } from 'lucide-react';
            ...
            >
              <div className="space-y-4">
                ...
                <div className="space-y-1.5">
                  ...
                  <div className="divide-y divide-slate-800/80 rounded-xl bg-slate-800/40 p-2 text-xs border border-slate-800">
              ...
              <div className="pt-4 mt-4 border-t border-slate-800 flex items-center justify-end gap-2">
                ...
                <button
                  ...
                  className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-rose-950/40 hover:bg-rose-900/60 text-rose-400 border border-rose-900/50 text-xs font-semibold transition-colors cursor-pointer"
                >
        ...
        <div className="space-y-4 text-xs">
          ...
          <div className="flex justify-end pt-2">
            <button
              ...
              className="px-4 py-2 text-sm font-medium text-slate-300 hover:bg-slate-800 rounded-lg cursor-pointer"
            >
              Close
            </button>
          </div>

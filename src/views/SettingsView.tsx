...
import { Store, Percent, FileText, CheckCircle2, Save } from 'lucide-react';
      ...
      <div className="lg:col-span-7 space-y-4 sm:space-y-6">
        ...
        <div className="flex items-center justify-end gap-3 pt-2">
          ...
          <button
            type="submit"
            disabled={saving}
            className="flex items-center gap-2 px-6 py-2.5 bg-indigo-600 hover:bg-indigo-700 text-white text-sm font-semibold rounded-xl shadow-lg shadow-indigo-600/30 transition-colors disabled:opacity-50 cursor-pointer"
          >
            {saving ? (
